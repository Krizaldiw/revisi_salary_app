...
<!-- Page Heading -->
    ...
    <div class="card mb-3">
        ...
        <div class="card-body">
            <form class="form-inline">
                ...
                <a href="http://localhost/salary/admin/data_absensi"><div class="btn btn-sm btn-warning mb-2 ml-2"><i class="fas fa-undo"></i> Kembali</div></a>
            </form> 
        </div>    
    </div>
    <?php 
    ...
    <form method="POST">
        ...
        <?php }else{ ?>
            <span class="badge badge-danger"><i class="fas fa-info-circle">Bulan dan Tahun yang anda pilih sudah di proses, Silahkan kembali ke laman Absensi Pegawai.</i></span>
        <?php } ?>
    </form>
</div>    