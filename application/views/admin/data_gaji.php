...
<!-- Page Heading -->
            ...
            <form class="form-inline">
                ...
                <div class="form-group mb-2 ml-3">
                    ...
                    <select class="form-control ml-3" name="tahun">
                        ...
                        <?php $tahun = date('Y'); for ($i=2020; $i<$tahun+5; $i++) { ?>
                ...
                <?php if(count($gaji) > 0) { ?>
                    <a href="<?php echo base_url('admin/data_gaji/cetak_gaji?bulan='.$bulan),
                    '&tahun='.$tahun ?>" class="btn btn-sm btn-success mb-2 ml-2" >
                    <i class="fas fa-print"></i> Cetak Slip Gaji</a>              
                <?php } else { ?>
                    <!-- Button trigger modal -->
                    <button type="button" class="btn btn-sm btn-success mb-2 ml-2" data-toggle="modal" data-target="#exampleModal">
    ...
    <?php }else{ ?>
            <span class="badge badge-danger">
                <i class="fas fa-info-circle">Data Absensi masih kosong, Silahkan 
                input data kehadiran pada bulan dan tahun yang anda pilih.
            </i></span>
    <?php } ?>
</div>    
<!-- Modal -->
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        Maaf belum bisa mencetak slip gaji, Silahkan input absensi terlebih dahulu 
      </div>
