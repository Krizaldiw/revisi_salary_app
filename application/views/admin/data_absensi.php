    ...
    <div class="card mb-3">
        ...
        <div class="card-body">
            <form class="form-inline">
                ...
                <button type="submit" class="btn btn-sm btn-primary mb-3 ml-auto"><i class="fas fa-eye"></i> Tampilkan Data</button>
                <a href="<?php echo base_url('admin/data_absensi/input_absensi') ?>" class="btn btn-sm btn-success mb-3 ml-2" ><i class="fas fa-plus"></i> Input Kehadiran</a>
            </form> 
        </div>    
    </div>
    <?php 
